...
business_selection = st.sidebar.selectbox("판매 채널 선택", ["전체", "B2B (건설사/대리점 납품)", "B2C (대림몰/쿠팡/에이블리)", "직영쇼룸(논현 등)"])
product_selection = st.sidebar.selectbox("주요 품목 선택", ["전체", "위생도기(양변기/세면기)", "일체형 비데 (FÜLEN)", "욕실 리모델링 패키지"])
