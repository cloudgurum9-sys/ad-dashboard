...
def generate_ybm_anomalies():
    ...
    anomalies = [
        ...
        {"전표일자": "2026-04-10", "데이터 구분": "Bizplay 경비", "이상치 발생 사유": "마케팅 부서 법인카드 고액 결제 (예산 한도 초과)", "탐지금액": 1721441},
        {"전표일자": "2026-04-10", "데이터 구분": "SaaS/구독료", "이상치 발생 사유": "AWS 클라우드 서버 이용료 (환율 변동률 이상치)", "탐지금액": 1670495},
    ]
